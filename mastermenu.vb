...
Public Class mastermenu
    ...
    Private Sub mastermenu_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        dgv()
    End Sub
    Private Sub mastermenu_Closed(sender As Object, e As EventArgs) Handles MyBase.Closed
        txtnama.Select()
        If conn.State = ConnectionState.Open Then conn.Close()
        conn = Nothing
    End Sub
    Private Sub mastermenu_Deactivate(sender As Object, e As EventArgs) Handles MyBase.Deactivate
        txtnama.Select()
    End Sub
    Private Sub txtharga_LostFocus(sender As Object, e As EventArgs)
